...
export const ERROR_MESSAGES = {
  QUOTA_EXCEEDED: "Quota exceeded for quota metric 'Gemini 3.0 Pro Requests'",
  QUOTA_EXCEEDED_SHORT: "⚠️ Gemini 3.0 Pro daily quota exceeded. Please retry with model: 'gemini-3.0-flash' or 'gemini-2.5-flash'",
...
export const STATUS_MESSAGES = {
  QUOTA_SWITCHING: "🚫 Gemini 3.0 Pro quota exceeded, switching to Flash model...",
  FLASH_RETRY: "⚡ Retrying with Gemini 3.0 Flash...",
  FLASH_SUCCESS: "✅ Gemini 3.0 Flash completed successfully",
...
// Models
export const MODELS = {
  // Legacy Gemini 3 naming (not available in non-interactive mode)
  PRO_3: "gemini-3.0-pro",
  FLASH_3: "gemini-3.0-flash",
  // Gemini 2.5 models (fully supported)
  PRO: "gemini-2.5-pro",
